...
3. DETENER y reportar al invocador con el error textual exacto. El invocador (típicamente el `committer`) decide cómo enrutar (por ejemplo, escalando al Líder para que invoque al `developer`).
